...
export default function ProfileScreen({ closeProfileScreen, navigation }) {
  ...
  return (
    <BlurView intensity={100} style={{ position: 'absolute', height: '100%', width: '100%' }}>
          ...
          <ScrollView>
            ...
            >
              <Text style={{ color: 'black', fontSize: 20 }}>
                {user.firstName} {user.lastName}.{user.dotNumber}
              </Text>
              <TouchableOpacity
                style={{ padding: 5 }}
                onPress={() =>
            ...
            >
              ...
              <TouchableOpacity style={{ padding: 5 }} onPress={() => setShowEditModal([{ key: 'weight', label: 'weight', type: 'number-pad' }])}>
                <Feather name="edit" size={20} color="black" />
              </TouchableOpacity>
            </View>
            <View key={4} style={{ flexDirection: 'row', width: '100%', alignItems: 'center', justifyContent: 'space-between', borderRadius: 20 }}>
              <View
                style={{
                  backgroundColor: 'white',
                  flexDirection: 'row',
              ...
              >
                <TouchableOpacity style={{ padding: 5 }} onPress={() => setShowEditModal([{ key: 'diningDollars', label: 'Dining Dollars', type: 'numeric' }])}>
              ...
              >
                <TouchableOpacity style={{ padding: 5 }} onPress={() => setShowEditModal([{ key: 'buckIDCash', label: 'Buck ID Cash', type: 'numeric' }])}>
            ...
            {Object.keys(user.allergies).map((el) => (
              ...
              >
                <Text style={{ color: 'black', fontSize: 20 }}>
                  {el
                    .split('')
                    .map((letter, ind) => (letter == letter.toLowerCase() ? (ind == 0 ? letter.toUpperCase() : letter) : ' ' + letter))
                    .join('')}
                </Text>
                <Switch
      ...
      <TouchableOpacity style={{ padding: 10, position: 'absolute', marginTop: 50, right: 20 }} onPress={closeProfileScreen}>
        ...
        <BlurView intensity={100} style={{ flex: 1, justifyContent: 'flex-end', alignItems: 'center', flexDirection: 'column' }}>
          <View
            style={{
              ...
              backgroundColor: 'rgba(200, 10,10,.5)',
              borderTopLeftRadius: 20,
              borderTopRightRadius: 20,
            }}
          >
            {showEditModal.map((el, ind) => (
              <View id={ind}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', marginTop: 40 }}>
              ...
              <TouchableOpacity
                ...
                style={{
                  paddingHorizontal: 30,
                  paddingVertical: 10,
                  backgroundColor: 'rgba(0,200,0,.9)',
                  width: '40%',
                  borderRadius: 10,
                  justifyContent: 'center',
                  alignItems: 'center',
